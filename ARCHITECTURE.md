...
```mermaid
graph TB
    subgraph FE ["Frontend Environment (Browser)"]
    ...
    subgraph HostServer ["Host / Server System"]
        PB["Primary Backend\n(Express - Port 9090)"]
    ...
    ClientApp -->|Create/List Projects<br/>Bearer JWT| PB
    ClientApp -->|Poll prompts/actions<br/>Bearer JWT| PB
...
2. **Dashboard & Project Creation (`app/page.tsx` & `HomePrompt.tsx`)**
   - User inputs a text prompt (e.g., _"Create a recipe listing app"_).
